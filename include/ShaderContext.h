...
public:
    ...
    void set_cursor_pos(const GLint* cursor_pos_arr);
    void set_sprite_pos(size_t num_sprites, const float* sprite_pos_arr);
    void set_sprite_count(GLint sprite_count);
